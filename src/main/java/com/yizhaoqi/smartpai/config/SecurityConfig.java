...
public class SecurityConfig {
    ...
    @Autowired
    private ObjectProvider<PortfolioReadOnlyFilter> portfolioReadOnlyFilter;
        ...
        try {
            ...
            http.csrf(csrf -> csrf.disable())
                    ...
                    .authorizeHttpRequests(authorize -> authorize
                            ...
                            .requestMatchers("/api/v1/demo/health").permitAll()
                            // 允许测试接口
            ...
            PortfolioReadOnlyFilter demoFilter = portfolioReadOnlyFilter.getIfAvailable();
            if (demoFilter != null) {
                http.addFilterBefore(demoFilter, JwtAuthenticationFilter.class);
            }
